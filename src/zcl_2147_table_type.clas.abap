CLASS zcl_2147_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
**********************************************************************
    TYPES z TYPE SORTED TABLE OF /lrn/s_address
...
*        addresses  TYPE z2147t_addresses,
*      END OF st_person_deep.


*Task 3: Nested Table Type
**********************************************************************
*    TYPES tt_persons TYPE HASHED TABLE OF z2147s_person_deep
...
CLASS ZCL_2147_TABLE_TYPE IMPLEMENTATION.
